        ...
        string fileName = "dependency-graph.html")
    {
        try
        {
            var json = JsonSerializer.Serialize(reports, new JsonSerializerOptions
            {
                ...
                Converters = { new JsonStringEnumConverter() } // enum names stay as-is: "Direct", "Package", ...
            });
...
{
    //private const string path = "G:\\Projects\\Git\\Iman\\ImanSoftware.Site";
    private const string path = "G:\\Projects\\Git\\Iman";
